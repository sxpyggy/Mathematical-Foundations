...
```{r, echo=F}
y<-function(t) 1+4*t-5*t^2

t = pretty(c(0,5),3000)

plot(t,y(t),type = "l",xlab="t",ylab="h(t)", ylim = c(-50,10) )
abline(v=0,lty=2)
abline(h=0,lty=2)
```
...
```{r, echo=F}
y<-function(n) -500*n^2+20000*n+1600000

n = pretty(c(-500,500),3000)

plot(n,y(n),type = "l",xlab="n",ylab="R" )
abline(v=0,lty=2)
abline(h=0,lty=2)
```
