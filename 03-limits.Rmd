...
```{r,echo=FALSE,out.width="40%",fig.align = 'center',fig.cap="Figure of f(x)"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/3/right_limit.png")
```
...
```{r,echo=FALSE,out.width="70%",fig.align = 'center',fig.cap="Figure of f(x)"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/3/asymptote.png")
```
